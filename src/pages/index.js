  ...
  <div id={"root"}>
    ...
    <section className={"background header"}>
      <div className={"container-fluid container-hz"}>
        <div className={"image-container"}>
          <img className={"round"} id={"profile"} src={""}/>
        </div>
        <div className={"content-container"}>
          <h1 className={'display-4'}>
            <span className={"bold"}>Joshua</span> &nbsp;
            <span className={'light'}>Zahner</span>
          </h1>
    ...
    <section className={"background header"}>
      <div className={"container container-vt"}>
        ...
        <h4 className={"separate text-center"}>The go to blog for a mix of programming, ocean science, and conservation topics.</h4>
